LocalizationReady( 'friendsui', 'english', {
	...
	"FriendGroup_IncomingInvites_NoIncomingInvites": "No pending invites",
	...
	"Broadcast_EnglishA": "English A",
	"Broadcast_EnglishB": "English B",
	"Broadcast_EnglishC": "English C",
	"Broadcast_EnglishD": "English D",
	"Broadcast_EnglishNewbie": "English - Newcomer",
	"Broadcast_ChineseMain": "Chinese",
	"Broadcast_ChineseA": "Chinese A",
	"Broadcast_ChineseB": "Chinese B",
	"Broadcast_ChineseC": "Chinese C",
	"Broadcast_ChineseD": "Chinese D",
	"Broadcast_ChineseNewbie": "Chinese - Newcomer",
	"Broadcast_RussianMain": "Russian",
	"Broadcast_RussianA": "Russian A",
	"Broadcast_RussianB": "Russian B",
	"Broadcast_RussianC": "Russian C",
	"Broadcast_RussianD": "Russian D",
	...
	"Voice_DefaultCommunicationsDefault": "Communications Device",
	...
	"MobilePermission_TakePhoto": "Oops, looks like your device was told to deny us camera or photo library access!",
	"MobilePermission_ChoosePhoto": "Oops, looks like your device was told to deny us photo library access!",
	"MobilePermission_Ensure": "Please ensure your device grants us the necessary permissions and try again.",
	...
	"MobileWelcomePage_Chat_Body": "Check in with friends, coordinate a time to play with your group, or check out official game chats.",
	"MobileWelcomePage_Friends_Title": "See who's playing now",
	"MobileWelcomePage_Friends_Body": "Quickly see who is playing or is ready to play, so you never miss an opportunity.",
	"MobileWelcomePage_FriendLink_Title": "Add friends with a link",
	"MobileWelcomePage_FriendLink_Body": "Adding a friend on Steam is now as easy as texting or emailing a custom link.",
	"Button_Done": "Done",
	"Button_Skip": "Skip",
	...
	"PersonaStateOfflineDescriptor": "Sign out of Friends & Chat",
	...
	"PersonaStateInvisibleDescription": "Friends can't see you (you'll appear offline), but you can see them.",
	...
	"ConnectionTrouble_LoginProblem": "There was a problem logging you in.",
	...
	"Chat_TextFilter_Active": "Strong profanity and slurs are now obscured by default in Steam Chat. [url=%1$s]Review filtering settings[/url]",
	...
	"Chat_Settings_Error_LimitedUserInvite": "Limited users cannot send invite links",
	...
	"GroupSettings_Permissions_SetWatchingBroadcast": "Link and Unlink Broadcasts",
	"GroupSettings_Permissions_RoleName": "Role Name",
	"GroupSettings_Permissions_BackButton": "Back to Permissions",
	...
	"GroupSettings_Channels_Delete": "Delete",
	...
	"GroupSettings_Bans_AccessDenied": "Viewing the list of banned accounts is disabled because you do not have permission to ban people from this group chat.",
	...
	"GroupSettings_Mobile_FavoritesDesc": "Display this group at the top of my friends list so it's easy to find",
	...
	"ChatRoom_ServerMessage_SingleJoined_SingleParted": "%1$s joined the chat and %2$s left the chat",
	"ChatRoom_ServerMessage_SingleJoined_MultipleParted": "%1$s joined the chat and %2$s people left the chat",
	"ChatRoom_ServerMessage_MultipleJoined_SingleParted": "%1$s people joined the chat and %2$s left the chat",
	"ChatRoom_ServerMessage_MultipleJoined_MultipleParted": "%1$s people joined the chat and %2$s people left the chat",
	...
	"Chat_ErrorSending_RateLimitExceeded": "You have been sending too many messages in a short period of time.  Please wait and try again later.",
	...
	"Chat_MemberGroup_PartyBeacon": "Wants To Play",
	...
	"bbcode_linkremoved_desc": "WARNING: Suspicious URL: ",
	"Community_RemoveLink_Tooltip": "The URL that was linked here has been flagged by our filters.  Usually this is done to prevent phishing and malware attacks.",
	...
	"bbcode_invite_already_group_member_long": "You are already a member of this group",
	...
	"bbcode_steam_store_embed_From": "from ",
	"bbcode_steam_store_embed_ReleaseDate": "Release Date: ",
	"bbcode_steam_store_embed_ViewStorePage": "View Store Page",
	"bbcode_steam_store_embed_ViewStorePage_Filtered": "Proceed to Store Page Anyway",
	"bbcode_steam_store_embed_Image_Filtered": "Hidden",
	"bbcode_steam_store_embed_Filtered": "A Steam product page was shared that does not pass your chosen content filter.",
	"bbcode_steam_store_embed_Failed": "%1$s sent a %2$s link that failed to load. (%3$s)",
	"bbcode_steam_store_embed_Failed_Steam_Store": "Steam Store",

	"bbcode_flip_description": "%1$s flipped a coin",
	"bbcode_random_description": "%1$s generated a random number",
	...
	"Friend_Menu_StartVoiceChat": "Start Voice Chat",
	"Friend_Menu_StopVoiceChat": "Stop Voice Chat",
	...
	"Friend_Menu_Notifications": "Notifications",
	"Friend_Menu_NotificationsTitle": "Friend Notifications",
	"Friend_Menu_GameCommunityHub": "Game Community Hub",
	...
	"Friend_Menu_JoinFriendPartyBeacon": "Join Game",
	...
	"Friend_Block_Confirm": "Are you sure you want to block all communication with %1$s?  You won't be able to send or receive direct messages, won't receive notifications about incoming messages or calls from them, and won't be able to see their messages in chat rooms.",
	"Friend_Unblock_Confirm": "Are you sure you want to allow communication with %1$s again?",
	...
	"Friend_InviteError_LimitExceeded": "%1$s cannot be added to your friends list as your friends list is full.",
	"Friend_InviteError_AccessDenied": "There was an error adding %1$s to your friends list. Their friends list is full.",
	"Friend_InviteError_Blocked": "There was an error adding %1$s to your friends list. Communication between you and this user has been blocked.",
	"Friend_InviteError_InvalidState": "You are blocking all communication with %1$s. Before communicating with this user, you must unblock them by visiting their Steam Community Profile.",
	"Friend_InviteError_RateLimitExceeded": "It looks like you've sent too many friend invites recently. To prevent spam, you'll have to wait before you can invite more friends. Please note that other players can still add you during this time.",
	"Friend_InviteError_LimitedUser": "Your account does not meet the requirements to use this feature.",
	"Friend_InviteError_LimitedUserLink": "Your account does not meet the requirements to use this feature. %1$s for more information.",
	...
	"Friend_Kick_Confirm": "Are you sure you want to kick %1$s?",

	"Friend_Chat_Typing": "%1$s is typing a message...",
	"Friend_Chat_Blocked": "You have blocked this user.",

	"Friend_Chat_OpenError_Blocked": "Blocked Communication",
	"Friend_Chat_OpenError_BlockedBody": "You cannot chat with anyone you've blocked all communication with.",
	...
	"Friend_Notification_GameInviteRemotePlay": "%1$s invited you to play %2$s via Steam Remote Play",
	...
	"SlashCommandDescription_Random": "Pick a random number ( i.e. /random 1000 or /random 500-1000 )",
	...
	"FriendGroup_Search_NoResults": "no results found for '%1$s'",
	"FriendGroup_Search_CantFind": "Can't find who you're looking for?",
	"FriendGroup_Search_Link": "Search across all of Steam",
	...
	"MobileChatUploadLogsDesc": "Would you like to upload your app logs to help us diagnose this issue?",
	...
	"RemotePlay_Kick": "Kick Player",
	"RemotePlay_CancelInvite": "Cancel Invite",
	"RemotePlay_StreamPaused": "Stream Is Paused (return to game to resume)",
	"RemotePlay_EndStream": "End Stream",
	"RemotePlay_LeaveStream": "Leave Stream",
	"RemotePlay_ClientQualityFast": "Quality (Fast)",
	"RemotePlay_ClientQualityBalanced": "Quality (Balanced)",
	"RemotePlay_ClientQualityBeautiful": "Quality (Beautiful)",
	...
	"RemotePlay_ErrorInviteFailed_ParentalUnlockFailed": "Remote Play Together invite failed because this game has not been approved in Family View.",
	"RemotePlay_ErrorInviteFailed_ScreenLocked": "Remote Play Together invite failed because the screen is locked.",
	"RemotePlay_ErrorInviteFailed_Failed": "Remote Play Together invite failed, couldn't start streaming session.",
	"RemotePlay_ErrorInviteFailed_DriversNotInstalled": "Remote Play Together requires additional driver installation, follow the Steam prompts to install drivers.",
	"RemotePlay_ErrorInviteFailed_Disabled": "Remote Play Together invite failed because Remote Play is disabled in settings.",
	"RemotePlay_ErrorInviteFailed_BroadcastingActive": "Remote Play Together invite failed because a broadcast is active.",
	"RemotePlay_ErrorInviteFailed_VRActive": "Remote Play Together invite failed because VR is active.",
	"RemotePlay_ErrorInviteFailed_TransportUnavailable": "Remote Play Together invite failed because Remote Play networking is not currently available, try again later.",
	"RemotePlay_ErrorInviteFailed_Invisible": "Remote Play Together invite can't be sent while you are Invisible.",
	"RemotePlay_ErrorInviteFailed_RestrictedCountry": "Remote Play Together invite failed because this game is not available in your country.",
	...
	"Friends_NameChangeDenied_Info": "Invalid profile name. Please choose another name and try again.",
	"Friends_NameChangeCooldown_Info": "You are currently unable to set a profile name.",
	...
	"FriendSettings_CategorizeInGameFriendsByGame": "Group friends together by game",
	...
	"FriendSettings_Notification_ChatMessageDesc": "Disable push notifications from friends that don't have friend specific settings",
	"FriendSettings_Notification_ChatRoomNotificationDesc": "Disable all push notifications from group chats",
	"FriendSettings_DisableRoomEffects": "Disable animated room effects",
	"FriendSettings_AnimatedAvatars": "Enable Animated Avatars in your Friends List and Chat",
	...
	"FriendSettings_Notification_DirectChat": "Notify me when I receive a direct message",
	"FriendSettings_Notification_DirectChatDescOn": "Unless I have specific settings for that friend",
	"FriendSettings_Notification_DirectChatDescOff": "You're only receiving notifications from friends you've specifically allowed",
	"FriendSettings_Notification_GroupChat": "Notify me for group chat activity",
	"FriendSettings_Notification_GroupChatDescOn": "Unless I have specific settings for that group chat",
	"FriendSettings_Notification_GroupChatDescOff": "You're not receiving notifications for group chats",
	"FriendSettings_FriendNotification_FriendJoins": "When this friend joins a game",
	"FriendSettings_FriendNotification_FriendOnline": "When this friend comes online",
	...
	"FriendSettings_Notification_Explanation": "We'll try not to send you notifications if you're using Steam somewhere else.",
	...
	"FriendSettings_Mobile_Title": "Friend Settings",
	"FriendSettings_Mobile_FavoritesDesc": "Display this person at the top of my friends list so they're easy to find",
	"FriendSettings_Mobile_BlockDesc": "They'll see you as offline and you won't receive chat messages from them",
	"FriendSettings_Mobile_Notifications": "Mobile Notifications",
	"FriendSettings_Mobile_InlineEmbedOnWifiOnly": "Only embed images and other media when on wifi",
	...
	"FriendSettings_Mobile_SaveImageCaptures_Desc": "Images you capture within the app will be saved to your device's camera roll.",

	"Mobile_SaveImageCaptures_AlertTitle": "Image Saved",
	"Mobile_SaveImageCaptures_AlertBody": "We've saved the image to your device's camera roll.\n\nYou can disable this behavior in Settings > Interface.",
	...
	"LanguageSettings_ConfirmDescription": "Changing the language requires restarting Steam Chat.\n\nContinue?",
	...
	"FriendInviteLink_MobileDescription": "Generate a link you can drop into a text message or email.",
	"FriendInviteLink_Note": "When someone clicks on the link, you'll be added to each other's Friends List.",
	...
	"FriendInviteLink_DeleteLink_Prompt": "Are you sure you want to delete this invite link?",
	"FriendInviteLink_CreatedTime": "Created %1$s",
	"FriendInviteLink_AddFriend": "Add Friend",
	"FriendInviteLink_InvalidLink": "Invalid Link",
	"FriendInviteLink_SelfLink": "You followed a valid friend invite for your own account.",
	...
	"ChatRoom_GameInvite_Family_View": "This game has not been approved in Family View.",
	...
	"ChatRoom_GameInviteRemotePlay_Invite": "%1$s invited you using Remote Play Together",
	"ChatRoom_GameInviteRemotePlay_Accept": "Connect",
	"ChatRoom_GameInviteRemotePlay_Dismissed": "%1$s invited you to play %2$s%3$s via Steam Remote Play",
	"ChatRoom_GameInviteRemotePlay_YouInvited": "You invited %1$s to play %2$s%3$s via Steam Remote Play",
	"ChatRoom_GameInviteRemotePlay_Accepted": "You accepted an invitation to play %1$s%2$s via Steam Remote Play",
	"ChatRoom_GameInviteRemotePlay_CantAccept": "%1$s invited you to play %2$s%3$s via Steam Remote Play, but it is not available in your country",
	...
	"EmoticonPicker_GetFestivitiesInTheStore": "Get animated stickers and room effects in the %1$s.",
	...
	"TextFilterStatus_Enabled_IgnoreFriends": "Currently set to filter profanity and slurs from everyone except friends",
	"TextFilterStatus_EnabledAllowProfanity": "Currently set to allow profanity, but filter slurs",
	"TextFilterStatus_EnabledAllowProfanity_IgnoreFriends": "Currently set to allow profanity, but filter slurs from everyone except friends",
	...
	"NotificationSetting_ChannelOverrides": "Channel overrides:",
	...
	"RecentChats_HideFriend_Description1": "This chat will be hidden from the list until a new message is sent to the chat.",
	"RecentChats_HideFriend_Description2": "You can still access it from the friends list.",
	"RecentChats_HideGroup_Description1": "This chat will be hidden from the list until you interact with it again.",
	"RecentChats_HideGroup_Description2": "You can still access it from the groups list.",
	...
	"changeLog_SubTitle": "Here's what's been happening with Steam Friends & Chat lately",
	...
	"changeLog_UpdateItem72": "The emoticon selector now requires 3 characters to open, so you can send emoticons such as :D directly.",
	"changeLog_UpdateItem73": "Fixed an issue with text formatting on some Steam store embeds in chat.",
	"changeLog_UpdateItem74": "Fixed an issue with consecutive emoticons overlapping.",

	"changeLog_UpdateItem75": "Increased the blur on spoiler-tagged images in chat.",
	"changeLog_UpdateItem76": "Added a /store command, which allows quickly sending links to Steam store games.",
	"changeLog_UpdateItem77": "The Steam Chat mobile app is now available for %1$s and %2$s!",
